...
export const metadata: Metadata = {
  title: "Pricing Plans - Flexible AI Marketing Solutions | Imprintly",
  description:
  ...
  keywords:
    "AI marketing pricing, content generation plans, XM Cloud pricing, social media automation cost, Imprintly pricing",
  openGraph: {
    title: "Pricing Plans - Flexible AI Marketing Solutions | Imprintly",
    description:
      "Choose from Starter ($49/month), Pro ($149/month), or Enterprise (custom) plans. All include AI content generation, XM Cloud integration, and social media automation.",
    type: "website",
    url: "https://imprintly.com/pricing",
  },
  twitter: {
  ...
  const faqs = [
    {
      ...
      answer:
        "Our AI models are trained on high-quality marketing content and achieve 95%+ accuracy rates. All content includes built-in fact-checking and can be easily edited before publishing.",
    },
    {
