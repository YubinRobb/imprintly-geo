...
export const metadata: Metadata = {
  title: "Features - AI-Powered Marketing Content Generation | Imprintly",
  description:
    "Discover powerful features including AI keyword discovery, content generation, XM Cloud publishing, multi-platform social automation, and real-time GEO scoring.",
  keywords:
    "AI keyword discovery, AI content generation, XM Cloud publishing, social media automation, GEO scoring, content generation features",
  openGraph: {
    title: "Features - AI-Powered Marketing Content Generation | Imprintly",
    description:
      "Discover powerful features including AI keyword discovery, content generation, XM Cloud publishing, multi-platform social automation, and real-time GEO scoring.",
    type: "website",
    url: "https://imprintly.com/features",
  },
  twitter: {
...
export default function FeaturesPage() {
  const features = [
    ...
    },
    {
      ...
      description:
        "Generate blog posts, landing pages, and marketing copy that's optimized for AI-powered search engines and generative AI systems. Our AI models understand context, entities, and structured information.",
      benefits: [
        "Produce GEO-optimized content in minutes, not hours",
