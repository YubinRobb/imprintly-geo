...
export const metadata: Metadata = {
  title: "About Us - Democratizing AI-Powered Marketing | Imprintly",
  description:
    "Learn about our mission to democratize AI-powered marketing through advanced AI models, XM Cloud integration, and multi-platform automation.",
  keywords:
    "AI marketing company, AI content generation, XM Cloud specialists, marketing automation experts, Imprintly team",
  openGraph: {
    title: "About Us - Democratizing AI-Powered Marketing | Imprintly",
    description:
      "Learn about our mission to democratize AI-powered marketing through advanced AI models, XM Cloud integration, and multi-platform automation.",
    type: "website",
    url: "https://imprintly.com/about",
  },
  twitter: {
  ...
  const values = [
    {
      ...
      title: "Our Mission",
      description:
        "Democratize AI-powered marketing by making advanced content generation accessible to businesses of all sizes.",
    },
    {
      icon: Lightbulb,
  ...
  const futureReasons = [
    {
      ...
      description: "Cutting-edge AI that understands context, intent, and brand voice better than any previous technology.",
    },
    {
      icon: Zap,
          ...
          <Card className="border-0 shadow-xl">
            <CardContent className="p-8">
              <p className="text-lg text-gray-600 leading-relaxed text-center">
                ...
                optimized for AI-powered search engines and generative AI systems, at the exact moment your audience needs it.
                Generative Engine Optimization (GEO) represents the evolution beyond traditional SEO, where content is structured
                for AI comprehension, entity recognition, and direct answer generation. When combined with XM Cloud's publishing
                capabilities and multi-platform automation, marketers can achieve unprecedented scale and efficiency.
              </p>
            </CardContent>
          </Card>
        </div>
